...
def create_app():
    ...
    def register():
        if request.method == 'POST':
            ...
            # Crea un nuevo usuario y establece la contraseña utilizando set_password
            nuevo_usuario = Usuario(nombre=nombre, apellido=apellido, email=email, fechaNacimiento=fecha_nacimiento, pais=pais)
            nuevo_usuario.set_password(contraseña)  # Establecer la contraseña utilizando el método set_password
    ...
    def editar_usuario_id(id):
        ...
        if request.method == 'POST':
            ...
            usuario_editar.email = request.form['email']
            usuario_editar.fechaNacimiento = request.form['fechaNacimiento']
            usuario_editar.pais = request.form['pais']
