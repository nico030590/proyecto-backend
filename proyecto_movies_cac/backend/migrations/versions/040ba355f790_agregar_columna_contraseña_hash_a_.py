"""Agregar columna contraseña_hash a Usuario

Revision ID: 040ba355f790
Revises: ef999559fc04
Create Date: 2024-06-19 10:07:07.058090
...
revision = '040ba355f790'
down_revision = 'ef999559fc04'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('usuarios', schema=None) as batch_op:
        batch_op.add_column(sa.Column('contraseña_hash', sa.String(length=128), nullable=False))
